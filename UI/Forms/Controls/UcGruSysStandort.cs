...
{
    public partial class UcGruSysStandort : UserControl
    {
        // 
        // Class Properties
        //
        protected WsGruSysStandort Workspace;

        public UcGruSysStandort()
        {
            InitializeComponent();
            BindEvents();
            InitializeWorkspace();
        ...
        {
            Workspace = new WsGruSysStandort();
            BindView();
        }
        ...
        private void SetViewColumns()
        {
            ...
            {
                Column.HeaderText = ResUcGruSysStandort.StandortId; // Read Resource File
                Column.DataPropertyName = "StandortId";
                Column.Visible = true;
                Columns.Add(Column);
            }
            ...
            Column = new DataGridViewTextBoxColumn();
            {
                Column.HeaderText = ResUcGruSysStandort.Standort; // Read Resource File
                Column.DataPropertyName = "Standort";
                Column.Visible = true;
                Columns.Add(Column);
            }
